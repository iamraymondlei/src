...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/conceptvideo/js/index.js"></script>
...
<script>
<?php
echo isset($ps)?'Conceptvideo.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Conceptvideo.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Conceptvideo.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Conceptvideo.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Conceptvideo.catId = "'.$ci.'";':"";
echo 'Conceptvideo.newsId = "'.$_GET['id'].'";';
echo 'Conceptvideo.dataCount="'.$itemCount.'";';
