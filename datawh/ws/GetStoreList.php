...
/**
 * Description of GetStoreList
 *
 * @author icm
 */

class GetStoreList extends WebService implements iWebService {
    ...
    private function getStore() {
        $result = $this->db->query("SELECT s.* FROM Store s ORDER BY s.`CreationTime` DESC;");
        $this->outputData = array("StoreList"=>array("Store"=>$result));
    }
