...
class TypicalController extends Controller
{
    ...
    public function index()
    {
        ...
        $newsList = (new TypicalModel("CatNodeList"))->search($params);
        $this->assign('rootDir', $this->_config["rootDir"]);
        $this->assign('title', '先进典型');
    ...
    public function edit()
    {
        ...
        $removeHtmlTag = FALSE;
        $news = (new TypicalModel("CatNodeList"))->search($params,$removeHtmlTag);
        $this->assign('rootDir', $this->_config["rootDir"]);
    ...
    public function update()
    {
        ...
        $result = (new TypicalModel("News"))->update($_GET['id'],$data);
