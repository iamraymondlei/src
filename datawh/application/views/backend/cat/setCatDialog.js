...
setCatDialog.Clear = function() {
    ...
    setCatDialog.fileCatId = null;
    setCatDialog.fileCatName = "";
    setCatDialog.fileCatParentId = "";
};
...
setCatDialog.EditFileCat = function(id,name,pId) {
    ...
    if(id && name){
        setCatDialog.fileCatName = name;
        setCatDialog.fileCatId = id;
...
setCatDialog.DrawFileCatName = function() {
    var params = {
        ...
        value:setCatDialog.fileCatName,
        title:"分类名称：",
...
setCatDialog.GetSaveData = function() {
    ...
    if(setCatDialog.action === "update"){
        saveData.id = setCatDialog.fileCatId;
    }
    return saveData;
};