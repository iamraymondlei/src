...
function GeometryReshapingTool() {
	...
	var h = new go.Shape();
  h.figure = "Diamond";
  h.desiredSize = new go.Size(20, 20);
  h.fill = "lightblue";
  h.stroke = "dodgerblue";
  h.cursor = "move";
  /** @type {GraphObject} */
...
/**
* @name GeometryReshapingTool#coordinateData
* @function.
* @return {Object}
*/
Object.defineProperty(GeometryReshapingTool.prototype, "coordinateData", {
  get: function() { return this._coordinateData; },
  set: function(val) { this._coordinateData = val; }
});

/**
* @name GeometryReshapingTool#mouseMoveCB
* @function.
* @return {Object}
*/
Object.defineProperty(GeometryReshapingTool.prototype, "mouseUpCB", {
  get: function() { return this._mouseUpCB; },
  set: function(val) { this._mouseUpCB = val; }
});
...
* @return {Object}
*/
Object.defineProperty(GeometryReshapingTool.prototype, "mouseMoveCB", {
  get: function() { return this._mouseMoveCB; },
  set: function(val) { this._mouseMoveCB = val; }
});

/**
* @name GeometryReshapingTool#customData
* @function.
* @return {Object}
*/
Object.defineProperty(GeometryReshapingTool.prototype, "customData", {
  get: function() { return this._customData; },
  set: function(val) { this._customData = val; }
});

/**
* @name GeometryReshapingTool#part
* @function.
* @return {Object}
*/
Object.defineProperty(GeometryReshapingTool.prototype, "part", {
  get: function() { return this._part; },
  set: function(val) { this._part = val; }
});
...
GeometryReshapingTool.prototype.doMouseUp = function() {
  ...
  if (this.isActive && diagram !== null) {
    ...
    this.mouseUpCB(this.coordinateData,this.customData);
  }
  this.stopTool();
};
...
GeometryReshapingTool.prototype.updateCoordinateData = function() {
    var geo = this.adornedShape.geometryString;
