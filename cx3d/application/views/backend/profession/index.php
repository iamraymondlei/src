...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/profession/js/index.js"></script>
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 id="Profession-title"><?php echo $title; ?></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<script>
<?php
echo isset($ps)?'Profession.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Profession.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Profession.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Profession.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Profession.catId = "'.$ci.'";':"";
echo 'Profession.dataCount="'.$itemCount.'";';
