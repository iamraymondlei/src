...
echo <<<htmlHead
    ...
    <link rel="stylesheet" href="$dir/plugins/fileupload/9.12.1/css/jquery.fileupload.css">
    <!-- The jQuery UI widget factory, can be omitted if jQuery UI is already included -->
    <script src="$dir/plugins/fileupload/9.12.1/js/vendor/jquery.ui.widget.js"></script>
    <!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
    <script src="$dir/plugins/fileupload/9.12.1/js/jquery.iframe-transport.js"></script>
    <!-- The basic File Upload plugin. wiki:https://github.com/blueimp/jQuery-File-Upload/wiki/Basic-plugin -->
    <script src="$dir/plugins/fileupload/9.12.1/js/jquery.fileupload.js"></script>

    <!-- 图片缩放 plugin. from:https://github.com/adeelejaz/jquery-image-resize -->
    <script src="$dir/plugins/imageResize/jquery.ae.image.resize-2.1.3-min.js"></script>
