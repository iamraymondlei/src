...
class HistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $newsList = (new HistoryModel("CatNodeList"))->search($params);
        $this->assign('rootDir', $this->_config["rootDir"]);
        $this->assign('title', '光辉历程');
    ...
    public function edit()
    {
        ...
        $removeHtmlTag = FALSE;
        $news = (new HistoryModel("CatNodeList"))->search($params,$removeHtmlTag);
        $this->assign('rootDir', $this->_config["rootDir"]);
    ...
    public function update()
    {
        ...
        $result = (new HistoryModel("News"))->update($_GET['id'],$data);
