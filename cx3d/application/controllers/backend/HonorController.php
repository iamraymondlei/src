...
class HonorController extends Controller
{
    ...
    public function index()
    {
        ...
        $newsList = (new HonorModel("CatNodeList"))->search($params);

        $this->assign('rootDir', $this->_config["rootDir"]);
        $this->assign('title', '光影记忆');
    ...
    public function edit()
    {
        ...
        $news = (new HonorModel("CatNodeList"))->search($params);
        $this->assign('rootDir', $this->_config["rootDir"]);
    ...
    public function update()
    {
        ...
        $result = (new HonorModel("News"))->update($_GET['id'],$data);
