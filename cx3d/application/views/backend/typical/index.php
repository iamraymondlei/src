...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/typical/js/index.js"></script>
...
<script>
<?php
echo isset($ps)?'Typical.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Typical.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Typical.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Typical.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Typical.catId = "'.$ci.'";':"";
echo 'Typical.dataCount="'.$itemCount.'";';
