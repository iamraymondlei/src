...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/honor/js/index.js"></script>
...
<script>
<?php
echo isset($ps)?'Honor.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Honor.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Honor.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Honor.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Honor.catId = "'.$ci.'";':"";
echo 'Honor.dataCount="'.$itemCount.'";';
