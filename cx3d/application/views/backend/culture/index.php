...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/culture/js/index.js"></script>
...
<script>
<?php
echo isset($ps)?'Culture.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Culture.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Culture.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Culture.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Culture.catId = "'.$ci.'";':"";
echo 'Culture.dataCount="'.$itemCount.'";';
