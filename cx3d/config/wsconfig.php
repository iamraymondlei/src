...
require_once (dirname(__FILE__) . "/../framework/database/Database.Class.php");
//错误显示
...
class WsConfig {
    public static function includeClass() {
        $helpersFiles = self::getFilesFromDir("../ws/helpers","php");
        $baseClassFiles = self::getFilesFromDir("../ws/baseClass","php");
        $interfaceFiles = self::getFilesFromDir("../ws/interface","php");
