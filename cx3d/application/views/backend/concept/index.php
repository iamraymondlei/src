...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/concept/js/index.js"></script>
...
<script>
<?php
echo isset($ps)?'Concept.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Concept.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Concept.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Concept.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Concept.catId = "'.$ci.'";':"";
echo 'Concept.dataCount="'.$itemCount.'";';
