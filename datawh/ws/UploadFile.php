...
require('../public/plugins/fileupload/9.12.1/php/UploadHandler.php');
...
class UploadFile extends WebService implements iWebService {
    ...
    private function setFileUpload() {  
        ...
        $uploadFilePath = Config::$g_upload_file_path;
        $takeFilePath = Config::$g_take_file_path;
    ...
    private function getThumbnailSize($url) {
        $thumbPotSize = Config::$g_thumbPotSize;
