...
<!-- 对应js -->
<script src="<?php echo $rootDir; ?>/application/views/backend/promicrovideo/js/index.js"></script>
...
<script>
<?php
echo isset($ps)?'Promicrovideo.pageSize = "'.$ps.'";':"";
echo isset($pi)?'Promicrovideo.pageIndex = "'.$pi.'";':"";
echo isset($ob)?'Promicrovideo.orderBy = "'.$ob.'";':"";
echo isset($sb)?'Promicrovideo.sortBy = "'.$sb.'";':"";
echo isset($ci)?'Promicrovideo.catId = "'.$ci.'";':"";
echo 'Promicrovideo.newsId = "'.$_GET['id'].'";';
echo 'Promicrovideo.dataCount="'.$itemCount.'";';
